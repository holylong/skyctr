#ifndef _SKYCTR_COTR_H_
#define _SKYCTR_COTR_H_
...
namespace sky{
    namespace core{
        ...
        const std::string skyctr_set = "set";
        const std::string skyctr_cmake_version = "(VERSION 3.11)";
        const std::string skyctr_add_executable = "add_executable";
        const std::string skyctr_add_library = "add_library";

        const std::string skyctr_SHARED = "SHARED";
        const std::string skyctr_STATIC = "STATIC";
